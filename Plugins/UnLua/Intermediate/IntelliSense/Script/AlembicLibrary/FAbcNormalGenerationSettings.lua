...
---@field public bSkipComputingTangents boolean @Determines whether tangents are computed. Skipping them can improve streaming performance but may cause visual artifacts where they are required
