...
---@class UFractureCommonSettings : UObject
...
---@field public SurfaceResolution integer @Spacing between vertices on cut surfaces, where noise is added.  Larger spacing between vertices will create more efficient meshes with fewer triangles, but less resolution to see the shape of the added noise
---@field public OwnerTool UFractureTool
local UFractureCommonSettings = {}
