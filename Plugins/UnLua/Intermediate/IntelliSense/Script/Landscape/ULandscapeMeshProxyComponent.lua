...
---@field private ProxyComponentBases TArray<FIntPoint> @The components this proxy was generated for
---@field private ProxyLOD integer @LOD level proxy was generated for
