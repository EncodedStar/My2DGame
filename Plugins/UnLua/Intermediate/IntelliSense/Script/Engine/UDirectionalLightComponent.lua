...
---@field public bPerPixelAtmosphereTransmittance boolean @Whether to apply atmosphere transmittance per pixel on opaque meshes, instead of using the light global transmittance.
