...
---@field public MasterSubmix FSoftObjectPath @The Master submix through which all sounds are routed
...
---@field public GlobalMaxPitchScale number @The value to use to clamp the min pitch scale
