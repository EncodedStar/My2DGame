...
---@field public LowPassFilterFrequency number @Lowpass filter frequency
...
---@field public StereoBleed number
---@field public LFEBleed number @The amount of a sound to bleed to the LFE channel
---@field public VoiceCenterChannelVolume number @Voice center channel volume - Not a multiplier (does not propagate to child classes)
