...
---@field public SourceModels TArray<FStaticMeshSourceModel>
...
---@field public LightmapUVVersion integer @The lightmap UV generation version used during the last derived data build
---@field public bAutoComputeLODScreenSize boolean @If true, the screen sizees at which LODs swap are computed automatically.
---@field public MinLOD FPerPlatformInt @Minimum LOD to use for rendering.  This is the default setting for the mesh and can be overridden by component settings.
...
---@field public bIsBuiltAtRuntime boolean @If true, StaticMesh has been built at runtime
...
---@field public PositiveBoundsExtension FVector @Bound extension values in the positive direction of XYZ, positive value increases bound size
---@field public NegativeBoundsExtension FVector @Bound extension values in the negative direction of XYZ, positive value increases bound size
---@field public ExtendedBounds FBoxSphereBounds @Original mesh bounds extended with Positive/NegativeBoundsExtension
...
---@field public NavCollision UNavCollisionBase @Pre-build navigation collision
local UStaticMesh = {}
...
function UStaticMesh:SetLODGroup(NewGroup, bRebuildImmediately) end
