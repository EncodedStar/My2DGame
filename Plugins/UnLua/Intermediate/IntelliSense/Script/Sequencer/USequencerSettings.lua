...
---@field protected bKeyInterpPropertiesOnly boolean @Enable or disable only keyframing properties marked with the 'Interp' keyword.
...
---@field protected bKeepCursorInPlayRange boolean @Enable or disable keeping the cursor in the current playback range during playback.
