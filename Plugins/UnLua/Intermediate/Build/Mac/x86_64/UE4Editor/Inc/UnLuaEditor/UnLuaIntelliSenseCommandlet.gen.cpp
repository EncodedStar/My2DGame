...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUnLuaIntelliSenseCommandlet_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UUnLuaIntelliSenseCommandlet_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UUnLuaIntelliSenseCommandlet()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UUnLuaIntelliSenseCommandlet_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UUnLuaIntelliSenseCommandlet, 2764028979);
	template<> UNLUAEDITOR_API UClass* StaticClass<UUnLuaIntelliSenseCommandlet>()
	{
		return UUnLuaIntelliSenseCommandlet::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UUnLuaIntelliSenseCommandlet(Z_Construct_UClass_UUnLuaIntelliSenseCommandlet, &UUnLuaIntelliSenseCommandlet::StaticClass, TEXT("/Script/UnLuaEditor"), TEXT("UUnLuaIntelliSenseCommandlet"), false, nullptr, nullptr, nullptr);
